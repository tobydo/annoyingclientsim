    ...
    public class ThemeManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (changeRootFolder.boolValue == true)
            {
                ...
                {
                    rootFolder.stringValue = "DreamOS - Complete OS UI/Prefabs/";
                ...
                EditorGUILayout.HelpBox("Make sure that the DreamOS directory matches. " +
                    "Don't forget to hit apply after changing the root. " +
                    "Example: Parent Folders/DreamOS - Complete OS UI/Prefabs.", MessageType.Warning);
            }
            ...
            GUILayout.BeginHorizontal();
            GUILayout.FlexibleSpace();
            GUILayout.Label("ID: B16-20211018");
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            GUILayout.Space(6);
        }
        ...
        void ResetToDefaults()
        {
            if (EditorUtility.DisplayDialog("Reset to defaults", "Are you sure you want to reset Theme Manager values to default?", "Yes", "Cancel"))
            {
                ...
                catch { Debug.LogWarning("<b>[Theme Manager]</b> Resetting failed."); }
            }
        }
    }
}
